# Generated by Django 4.0.6 on 2022-08-04 23:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_license', models.CharField(default='', max_length=150)),
                ...
                ('image', models.ImageField(null=True, upload_to='license/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charges_payable', models.DecimalField(decimal_places=2, default=0, max_digits=18)),
                ...
                ('interest_rate_apply_to_late_payment', models.DecimalField(decimal_places=2, default=0, max_digits=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('software_license', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compatibilities', to='licenses.softwarelicense')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='license_attribute_list', to='licenses.attribute')),
                ('software_license', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='license_attribute_list', to='licenses.softwarelicense')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='common_attribute',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attribute_list', to='licenses.commonattribute'),
        ),
    ]
